...
@section('content')
    <!-- Page Head
                ==========================================-->
    <section class="page-heading" style="background-color : {{ $colors[5]->color }} !important;">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2>{{ app()->getLocale() == 'en' ? 'franchising' : 'حق الامتياز' }}</h2>
                </div>
                <!--End col-->
                <div class="w-100"></div>
                <div class="col">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">{{ app()->getLocale() == 'en' ? 'franchising' : 'حق الامتياز' }}</li>
                    </ul>
                </div>
                <!--End col-->
            </div>
                ...
                <div class="row text-center">
                    <div class="col-md-7">
                        <div class="info-text">
                            ...
                            <a href="{{ asset('storage/uploads/pages/' . $content->brochure) }}" class="custom-btn"
                    ...
                    <div class="col-md-5">
                        <form class="contact-form ajax-form" method="post" action="{{ route('site.other_form') }}">
                            {!! csrf_field() !!}
                            <input type="hidden" name="type" value="franchising">
