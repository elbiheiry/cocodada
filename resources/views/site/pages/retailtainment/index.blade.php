...
@section('title')
    {{ app()->getLocale() == 'en' ? 'Retailtainment ' : 'اعياد الميلاد' }}
@endsection
@section('content')
    <!-- Page Head
                ==========================================-->
    <section class="page-heading">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2>{{ app()->getLocale() == 'en' ? 'Retailtainment ' : 'اعياد الميلاد' }}</h2>
                </div>
                <!--End col-->
                <div class="w-100"></div>
                <div class="col">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">{{ app()->getLocale() == 'en' ? 'Retailtainment ' : 'اعياد الميلاد' }}
                        </li>
                    </ul>
                </div>
                <!--End col-->
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-6">
                        <form class="contact-form ajax-form" method="post" action="{{ route('site.other_form') }}">
                            {!! csrf_field() !!}
                            <input type="hidden" name="type" value="retailtainment">
