...
<head>
    ...
    @if (request()->route()->getName() == 'site.article' ||
        request()->route()->getName() == 'site.services.single')
        @yield('meta')
    @else
    ...
    <meta name="google-site-verification" content="os7qpwW_XUkZorq1lMyDVme7qIHBTsWHYcBuwMdT6Mo" />
    <meta name="msvalidate.01" content="4924318BB590CE47FBA7F60F456A684F" />
    ...
    <!-- Css Base And Vendor
        ===================================-->
    @if (app()->getLocale() == 'ar')
        <link rel="stylesheet" href="{{ asset('public/site/vendor/bootstrap/bootstrap-ar.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('public/site/vendor/bootstrap/bootstrap-en.css') }}">
    @endif
    ...
    <link rel="stylesheet" href="{{ asset('public/site/vendor/datepicker/jquery.datetimepicker.min.css') }}">
    ...
    <noscript>
        <img height="1" width="1" src="https://www.facebook.com/tr?id=304120677552139&ev=PageView
        &noscript=1" />
    </noscript>
    <!-- End Facebook Pixel Code -->

    <meta name="p:domain_verify" content="fe4c17d47f5afa07f73beec24520d165" />

    <meta name="google-site-verification" content="uuXr_l5ME58l8Ep0TqJG17cYB5YpK3DixgOA_5SyOB0" />

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-27551841-1"></script>
    <script>
...
<body>
            ...
            <div class="modal-content text-center">
                <div class="modal-header custom-modal">
                    <h5 class="modal-title" id="exampleModalLabel">
                        {{ app()->getLocale() == 'en' ? 'Notes' : 'ملاحظات' }}</h5>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content text-center ajax-form" method="post" action="{{ route('site.join') }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        {{ app()->getLocale() == 'en' ? 'Join To our Team' : 'انضم لفريق العمل' }}</h5>
                </div>
                <div class="modal-body row">
                    <div class="col-md-6 col-sm-6 form-group">
                        <label>{{ app()->getLocale() == 'en' ? 'Full Name' : 'الاسم بالكامل' }} :</label>
                        <input type="text" class="form-control"
                            placeholder="{{ app()->getLocale() == 'en' ? 'Full Name' : 'الاسم بالكامل' }}"
                            name="name">
                    </div>
                    <div class="col-md-6 col-sm-6 form-group">
                    ...
                    <div class="col-md-12 col-sm-12 form-group">
                        ...
                        <select class="form-control" name="role">
                            <option selected="selected" value="0">
                                {{ app()->getLocale() == 'en' ? 'Apply As' : 'انضم الينا ك' }} :</option>
                            <option value="Animator">Animator</option>
                            <option value="Game coach">Game coach</option>
                            <option value="Dancer">Dancer</option>
                            <option value="DJ&amp;MC">DJ&amp;MC</option>
                            <option value="Decorator">Decorator</option>
                            <option value="Marketing and Business Development">Marketing and Business Development
                            </option>
                        </select>
                    </div>
                </div>
    ...
    <div class="loader">
        <div class="spinner">
            <img src="{{ asset('public/site/images/preloader.gif') }}">
        </div>
    </div>
    <!-- JS Base And Vendor
        ==========================================-->
    <script src="{{ asset('public/site/vendor/jquery/jquery.js') }}"></script>
    <script src="{{ asset('public/site/vendor/bootstrap/bootstrap.js') }}"></script>
    ...
    <script src="{{ asset('public/site/vendor/counterdown/countdown.js') }}"></script>
    <script src="{{ asset('public/site/vendor/datepicker/jquery.datetimepicker.full.min.js') }}"></script>
    ...
    <script>
        ...
        $('.ajax-form').ajaxForm({
            beforeSend: function() {
                $('#SubmitBTN').html(
                    "<i class='fas fa-envelope'></i>{{ app()->getLocale() == 'en' ? 'Wait' : 'انتظر' }}");
    ...
    <noscript>
        ...
        <img height="1" width="1" src="https://www.facebook.com/tr?id=910250985833224&ev=PageView
