        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content text-center" id="delete-form">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">delete download</h5>
                </div>
...
@section('content')
    <div class="page-head">
        <i class="fa fa-user"></i> downloads
        <ul class="breadcrumb">
    ...
    <div class="page-content">
        <form class="row ajax-form" action="{{ route('admin.downloads') }}" method="post">
            {!! csrf_field() !!}
        ...
        <div class="table-responsive-lg-lg" style="position: relative;">
            ...
            <table class="table table-bordered" id="datatable" style="width:100%">
                ...
                <tbody>
                    @include('admin.pages.downloads.templates.table')
                </tbody>
            </table>
        </div>
    </div>
