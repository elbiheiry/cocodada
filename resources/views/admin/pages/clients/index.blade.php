    ...
    <div id="common-modal" class="modal fade" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content text-center">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit vendors</h5>
                </div>
...
@section('content')
    <div class="page-head">
        <i class="fa fa-user"></i> Our vendors
        <ul class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i>home</a></li>
            <li class="active">Our vendors</li>
        </ul>
    </div>
    <!-- Page content
        ==========================================-->
    <div class="page-content">
        <form class="row ajax-form" action="{{ route('admin.clients') }}" method="post">
            {!! csrf_field() !!}
        ...
        <div class="table-responsive-lg-lg" style="position: relative;">
            ...
            <table class="table table-bordered" id="datatable" style="width:100%">
                ...
                <tbody>
                    @include('admin.pages.clients.templates.table')
                </tbody>
            </table>
        </div>
    </div>
