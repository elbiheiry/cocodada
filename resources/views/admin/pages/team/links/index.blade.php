...
@section('content')
    <div class="page-head">
        <i class="fa fa-user"></i> Team members links
        <ul class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i>home</a></li>
            <li class="active">Team members links</li>
        </ul>
    </div>
    <!-- Page content
        ==========================================-->
    <div class="page-content">
        <form class="row ajax-form" action="{{ route('admin.team.links', ['id' => $id]) }}" method="post">
            {!! csrf_field() !!}
            <div class="col-md-6 col-sm-6 form-group">
                <label>Please select social link icon</label>
                <input class="form-control" type="text" name="icon">
                <span class="text-danger">Please go this link to choose your icon : <a
        ...
        <div class="table-responsive-lg-lg" style="position: relative;">
            ...
            <table class="table table-bordered" id="datatable" style="width:100%">
                ...
                <tbody>
                    @include('admin.pages.team.links.templates.table')
                </tbody>
            </table>
        </div>
    </div>
