...
@section('content')
    ...
    <div class="page-content">
        <form class="row ajax-form" action="{{ route('admin.testimonials') }}" method="post">
            {!! csrf_field() !!}
            <span class="text-danger">To add a client please don't add a name in either languages </span>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="Member description in english" name="description_en"></textarea>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="form-group">
                    <label>Member description in arabic</label>
                    <textarea class="form-control" placeholder="Member description in arabic" name="description_ar"></textarea>
                </div>
            </div>
            <div class="col-md-12 col-sm-12">
                <div class="form-group">
