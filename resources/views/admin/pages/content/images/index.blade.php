...
@section('content')
    <div class="page-head">
        <i class="fa fa-user"></i> pages images
        <ul class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i>home</a></li>
            <li class="active">pages images</li>
        </ul>
    </div>
    <!-- Page content
        ==========================================-->
    <div class="page-content">
        <form class="row ajax-form" action="{{ route('admin.pages.images', ['id' => $id]) }}" method="post">
            {!! csrf_field() !!}
        ...
        <div class="table-responsive-lg-lg" style="position: relative;">
            ...
            <table class="table table-bordered" id="datatable" style="width:100%">
                ...
                <tbody>
                    @include('admin.pages.content.images.templates.table')
                </tbody>
            </table>
        </div>
    </div>
