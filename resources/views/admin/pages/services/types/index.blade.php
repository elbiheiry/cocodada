...
@section('content')
    <div class="page-head">
        <i class="fa fa-user"></i> Service categories
        <ul class="breadcrumb">
    ...
    <div class="page-content">
        <form class="row ajax-form" action="{{ route('admin.services.types', ['id' => $id]) }}" method="post">
            {!! csrf_field() !!}
        ...
        <div class="table-responsive-lg-lg" style="position: relative;">
            ...
            <table class="table table-bordered" id="datatable" style="width:100%">
                ...
                <tbody>
                    @include('admin.pages.services.types.templates.table')
                </tbody>
            </table>
        </div>
    </div>
